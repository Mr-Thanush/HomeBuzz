...
// Authentication & Profile public/private routes
...
// FIX: Swapped to .put since your controller updates user state data rather than executing a row deletion query
router.route('/admin/seller/reject/:id').put(verifyUserAuth, roleBasedAccess("admin"), rejectSellerRequest);
